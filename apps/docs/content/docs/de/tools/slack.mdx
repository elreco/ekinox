...
<iframe
  ...
  title="Slack Integration mit Ekinox"
  frameBorder="0"
...
- **Agent-Benachrichtigungen automatisieren**: Sende Echtzeit-Updates von deinen Ekinox-Agenten an jeden Slack-Kanal
- **Webhook-Endpunkte erstellen**: Konfiguriere Slack-Bots als Webhooks, um Ekinox-Workflows durch Slack-Aktivitäten auszulösen
...
In Ekinox ermöglicht die Slack-Integration Ihren Agenten, im Rahmen ihrer Workflows auf verschiedene Weise programmatisch mit Slack zu interagieren:
