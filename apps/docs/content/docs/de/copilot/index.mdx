...
Copilot ist dein Assistent im Editor, der dir hilft, Workflows mit KI zu erstellen und zu bearbeiten sowie diese zu verstehen und zu verbessern. Er kann:

- **Erklären**: Beantwortet Fragen zu Ekinox und deinem aktuellen Workflow
...
<Callout type="info">
  Copilot ist in deinem Ekinox-Abonnement enthalten und nutzt die KI-Credits deines Arbeitsbereichs.
</Callout>
...
- **Dokumentation**: Verweise auf Ekinox-Dokumentation
