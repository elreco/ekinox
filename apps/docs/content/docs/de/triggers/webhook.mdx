...
Webhooks ermöglichen externen Diensten die Ausführung von Workflows durch das Senden von HTTP-Anfragen an Ihren Workflow. Ekinox unterstützt zwei Ansätze für webhook-basierte Auslöser.
