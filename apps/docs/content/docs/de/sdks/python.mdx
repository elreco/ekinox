...
client = SimStudioClient(
    ...
    base_url="https://www.ekinox.app"  # optional, defaults to https://www.ekinox.app
)
...
```python
SimStudioClient(api_key: str, base_url: str = "https://www.ekinox.app")
```
...
<Tabs items={['Development', 'Production']}>
  <Tab value="Development">
    ...
    client = SimStudioClient(
        ...
        base_url=os.getenv("SIM_BASE_URL", "https://www.ekinox.app")
    )
    ```
...
<Steps>
  <Step title="Bei Sim anmelden">
    Navigiere zu [Sim](https://www.ekinox.app) und melde dich bei deinem Konto an.
  </Step>
