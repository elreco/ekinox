...
Block-Referenzen sind die Grundlage des Datenflusses in Ekinox-Workflows. Das Verständnis, wie man Ausgaben von einem Block korrekt als Eingaben für einen anderen referenziert, ist essenziell für den Aufbau funktionaler Workflows.
...
Ekinox validiert alle Referenzen beim Importieren von YAML:
