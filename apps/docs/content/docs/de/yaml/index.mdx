...
description: Vollständiger Leitfaden zum Schreiben von YAML-Workflows in Ekinox
---
...
YAML-Workflows bieten eine leistungsstarke Möglichkeit, Workflow-Konfigurationen in Ekinox zu definieren, zu versionieren und zu teilen. Dieser Referenzleitfaden behandelt die vollständige YAML-Syntax, Block-Schemas und Best Practices für die Erstellung robuster Workflows.

## Schnellstart

Jeder Ekinox-Workflow folgt dieser grundlegenden Struktur:
...
Ekinox unterstützt mehrere Kern-Blocktypen, jeder mit spezifischen YAML-Schemas:
