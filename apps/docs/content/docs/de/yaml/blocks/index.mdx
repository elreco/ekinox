---
title: Block-Schemas
description: Vollständige YAML-Schema-Referenz für alle Ekinox-Blöcke
---

import { Card, Cards } from "fumadocs-ui/components/card";

Dieser Abschnitt enthält die vollständigen YAML-Schema-Definitionen für alle verfügbaren Blocktypen in Ekinox. Jeder Blocktyp hat spezifische Konfigurationsanforderungen und Ausgabeformate.
