...
Die Ausführungs-Engine von Ekinox bringt Ihre Workflows zum Leben, indem sie Blöcke in der richtigen Reihenfolge verarbeitet, den Datenfluss verwaltet und Fehler elegant behandelt, sodass Sie genau verstehen können, wie Workflows in Ekinox ausgeführt werden.
...
Wenn Sie einen Workflow als API bereitstellen, macht Ekinox Folgendes:
- Erstellt einen eindeutigen HTTP-Endpunkt: `https://www.ekinox.app/api/workflows/{workflowId}/execute`
...
- Gehostet auf einer benutzerdefinierten Subdomain: `https://your-name.www.ekinox.app`
