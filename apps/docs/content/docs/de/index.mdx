...
# Ekinox Dokumentation

Willkommen bei Ekinox, einem visuellen Workflow-Builder für KI-Anwendungen. Erstellen Sie leistungsstarke KI-Agenten, Automatisierungs-Workflows und Datenverarbeitungs-Pipelines, indem Sie Blöcke auf einer Leinwand verbinden.

## Schnellstart

<Cards>
  <Card title="Einführung" href="/introduction">
    Erfahren Sie, was Sie mit Ekinox erstellen können
  </Card>
