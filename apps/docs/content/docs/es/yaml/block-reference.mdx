...
Las referencias de bloques son la base del flujo de datos en los flujos de trabajo de Ekinox. Entender cómo referenciar correctamente las salidas de un bloque como entradas para otro es esencial para construir flujos de trabajo funcionales.
...
Ekinox valida todas las referencias al importar YAML:
