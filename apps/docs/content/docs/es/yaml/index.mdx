...
description: Guía completa para escribir flujos de trabajo YAML en Ekinox
---
...
Los flujos de trabajo YAML proporcionan una forma potente de definir, versionar y compartir configuraciones de flujos de trabajo en Ekinox. Esta guía de referencia cubre la sintaxis completa de YAML, esquemas de bloques y mejores prácticas para crear flujos de trabajo robustos.

## Inicio rápido

Cada flujo de trabajo de Ekinox sigue esta estructura básica:
...
Ekinox admite varios tipos de bloques principales, cada uno con esquemas YAML específicos:
