...
description: Referencia completa del esquema YAML para todos los bloques de Ekinox
---

import { Card, Cards } from "fumadocs-ui/components/card";

Esta sección contiene las definiciones completas del esquema YAML para todos los tipos de bloques disponibles en Ekinox. Cada tipo de bloque tiene requisitos de configuración específicos y formatos de salida.
