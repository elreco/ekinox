...
El motor de ejecución de Ekinox da vida a tus flujos de trabajo procesando bloques en el orden correcto, gestionando el flujo de datos y manejando errores con elegancia, para que puedas entender exactamente cómo se ejecutan los flujos de trabajo en Ekinox.
...
Cuando despliegas un flujo de trabajo como API, Ekinox:
- Crea un punto de conexión HTTP único: `https://www.ekinox.app/api/workflows/{workflowId}/execute`
...
- Alojado en un subdominio personalizado: `https://your-name.www.ekinox.app`
