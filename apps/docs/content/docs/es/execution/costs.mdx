...
Ekinox calcula automáticamente los costos de todas las ejecuciones de flujos de trabajo, proporcionando precios transparentes basados en el uso de modelos de IA y cargos de ejecución. Entender estos costos te ayuda a optimizar los flujos de trabajo y gestionar tu presupuesto de manera efectiva.
...
<Tabs items={['Modelos alojados', 'Trae tu propia clave API']}>
  <Tab>
    **Modelos alojados** - Ekinox proporciona claves API con un multiplicador de precio de 2,5x:
...
- Revisa tu uso actual en [Configuración → Suscripción](https://www.ekinox.app/settings/subscription)
...
Cuando el exceso no facturado alcanza los 50$, Ekinox factura automáticamente el monto total no facturado.
