...
Copilot es tu asistente integrado en el editor que te ayuda a crear y editar flujos de trabajo con IA, así como a entenderlos y mejorarlos. Puede:

- **Explicar**: Responder preguntas sobre Ekinox y tu flujo de trabajo actual
...
<Callout type="info">
  Copilot está incluido con tu suscripción de Ekinox y utiliza los créditos de IA de tu espacio de trabajo.
</Callout>
...
- **Documentación**: Referencia la documentación de Ekinox
