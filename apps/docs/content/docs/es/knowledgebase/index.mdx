...
Simplemente carga tus documentos para comenzar. Ekinox los procesa automáticamente en segundo plano, extrayendo texto, creando incrustaciones y dividiéndolos en fragmentos buscables.
...
Para documentos PDF, Ekinox ofrece capacidades de procesamiento mejoradas:
...
Ekinox utiliza búsqueda vectorial impulsada por [pgvector](https://github.com/pgvector/pgvector) para entender el significado y contexto de tu contenido:
