...
<iframe
  ...
  title="Slack Integration with Ekinox"
  frameBorder="0"
...
- **Automate agent notifications**: Send real-time updates from your Ekinox agents to any Slack channel
- **Create webhook endpoints**: Configure Slack bots as webhooks to trigger Ekinox workflows from Slack activities
...
In Ekinox, the Slack integration enables your agents to programmatically interact with Slack in several ways as part of their workflows:
