...
The Loop block is a container block in Ekinox that allows you to create iterative workflows by executing a group of blocks repeatedly. Loops enable iterative processing in your workflows.
