...
Ekinox's execution engine brings your workflows to life by processing blocks in the correct order, managing data flow, and handling errors gracefully, so you can understand exactly how workflows are executed in Ekinox.
...
When you deploy a workflow as an API, Ekinox:
- Creates a unique HTTP endpoint: `https://www.ekinox.app/api/workflows/{workflowId}/execute`
...
- Hosted on a custom subdomain: `https://your-name.www.ekinox.app`
