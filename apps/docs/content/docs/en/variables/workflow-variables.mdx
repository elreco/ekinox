...
Variables in Ekinox act as a global store for data that can be accessed and modified by any block in your workflow, allowing you to store and share data across your workflow with global variables. They provide a powerful way to share information between different parts of your workflow, maintain state, and create more dynamic applications.
...
Variables in Ekinox can store various types of data:
...
Variables in Ekinox have global scope, meaning:
