...
Copilot est votre assistant intégré à l'éditeur qui vous aide à créer et à modifier des flux de travail avec l'IA, ainsi qu'à les comprendre et à les améliorer. Il peut :

- **Expliquer** : répondre aux questions sur Ekinox et votre flux de travail actuel
...
<Callout type="info">
  Copilot est inclus avec votre abonnement Ekinox et utilise les crédits IA de votre espace de travail.
</Callout>
...
- **Documentation** : référencer la documentation d'Ekinox
