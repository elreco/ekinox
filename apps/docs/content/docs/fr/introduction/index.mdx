...
Ekinox se connecte à plus de 80 services prêts à l'emploi :
...
**Hébergé dans le cloud** : Commencez instantanément sur [www.ekinox.app](https://www.ekinox.app) avec une infrastructure gérée, une mise à l'échelle automatique et une surveillance intégrée.
