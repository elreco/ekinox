...
description: Guide complet pour écrire des flux de travail YAML dans Ekinox
---
...
Les flux de travail YAML offrent un moyen puissant de définir, versionner et partager des configurations de flux de travail dans Ekinox. Ce guide de référence couvre la syntaxe YAML complète, les schémas de blocs et les meilleures pratiques pour créer des flux de travail robustes.

## Démarrage rapide

Chaque flux de travail Ekinox suit cette structure de base :
...
Ekinox prend en charge plusieurs types de blocs principaux, chacun avec des schémas YAML spécifiques :
