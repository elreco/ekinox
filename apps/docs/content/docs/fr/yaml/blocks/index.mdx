...
description: Référence complète du schéma YAML pour tous les blocs Ekinox
---

import { Card, Cards } from "fumadocs-ui/components/card";

Cette section contient les définitions complètes du schéma YAML pour tous les types de blocs disponibles dans Ekinox. Chaque type de bloc a des exigences de configuration spécifiques et des formats de sortie.
