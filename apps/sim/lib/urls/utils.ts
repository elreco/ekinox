 ...
 * @returns The domain with port if applicable (e.g., 'localhost:3000' or 'www.ekinox.app')
 */
export function getBaseDomain(): string {
  try {
    ...
    try {
      ...
      return isProd ? 'www.ekinox.app' : 'localhost:3000'
    }
  }
}
 ...
 * @returns The email domain (e.g., 'www.ekinox.app' instead of 'www.ekinox.app')
 */
