...
export function generateRuntimeCSP(): string {
  ...
  return `
    ...
    style-src 'self' 'unsafe-inline' https://fonts.googleapis.com;
    img-src 'self' data: blob: https://*.googleusercontent.com https://*.google.com https://*.atlassian.com https://cdn.discordapp.com https://*.githubusercontent.com https://api.producthunt.com ${brandLogoDomain} ${brandFaviconDomain};
    media-src 'self' blob: https://*.vercel-storage.com;
    font-src 'self' https://fonts.gstatic.com;
