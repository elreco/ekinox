        ...
        <div className='relative top-0 overflow-hidden border-border border-b px-6 py-16 sm:px-10 md:sticky md:h-dvh md:border-r md:border-b-0 md:px-12 md:py-24'>
          ...
          <div className='relative mx-auto h-full max-w-xl md:flex md:flex-col md:justify-center'>
            ...
            <p className={`${inter.className} mt-4 text-muted-foreground text-sm`}>
              Stay up-to-date with the latest features, improvements, and bug fixes in Ekinox. All
            ...
            <div className='mt-6 flex flex-wrap items-center gap-3 text-sm'>
              <Link
                href='https://docs.ekinox.app/releases'
                target='_blank'
                rel='noopener noreferrer'
                className='group inline-flex items-center justify-center gap-2 rounded-[10px] border border-[#2563eb] bg-gradient-to-b from-[#3b82f6] to-[#2563eb] py-[6px] pr-[10px] pl-[12px] text-[14px] text-white shadow-[inset_0_2px_4px_0_#1e40af] transition-all sm:text-[16px]'
              >
