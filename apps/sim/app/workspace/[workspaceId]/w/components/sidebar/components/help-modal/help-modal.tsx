                  ...
                  className={cn(
                    ...
                    submitStatus === 'error'
                      ...
                      : submitStatus === 'success'
                        ...
                        : 'bg-[var(--brand-primary-hex)] text-muted-foreground shadow-[0_0_0_0_var(--brand-primary-hex)] hover:bg-[var(--brand-primary-hover-hex)] hover:shadow-[0_0_0_4px_rgba(48,55,255,0.15)] disabled:opacity-50 disabled:hover:shadow-none'
                  )}
                >
                  {isSubmitting
                    ? 'Submitting...'
